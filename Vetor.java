	...
	public Vetor(int capacity) {
	 ...
	 public void bubbleSortPremium() {
		...
		public void mostrarPaisesOrdenados() {
			// ordena países em ordem de tarifa básica
			Pais[] tempArray = Arrays.copyOf(A, size);

			Arrays.sort(tempArray, Comparator.comparingDouble(pais -> pais.tarifaBasica));

			System.out.println("-------------------------------");
			System.out.println("\nPaíses ordenados por tarifa básica em ordem crescenter:");
